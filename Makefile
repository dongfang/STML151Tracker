...
SRCS = main.c system_stm32l1xx.c Trace.c trace_impl.c _sbrk.c CDCEL913.c Si4463_SPI.c systick.c WSPR.c ADC_DMA.c SimpleIRQDrivenWSPR.c GPS.c SelfCalibration.c RTC.c DAC.c nhash.c Constants.c
