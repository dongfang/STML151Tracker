...
#define REV_COARSE_BATT_ADC_FACTOR (READ_COARSE_BATT_ADC / BATT_MEASURED_VOLTAGE)

#define COARSE_BATT_ADC_2V7 (REV_COARSE_BATT_ADC_FACTOR * 2.7)
#define COARSE_BATT_ADC_3V0 (REV_COARSE_BATT_ADC_FACTOR * 3.0)
#define COARSE_BATT_ADC_3V3 (REV_COARSE_BATT_ADC_FACTOR * 3.3)
#define COARSE_BATT_ADC_3V7 (REV_COARSE_BATT_ADC_FACTOR * 3.7)
#define COARSE_BATT_ADC_4V2 (REV_COARSE_BATT_ADC_FACTOR * 4.2)
