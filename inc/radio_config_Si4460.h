...
#define RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ                     {PLL_XTAL_NOMINAL_FREQUENCY}
...
#define RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ_DEFAULT                     PLL_XTAL_NOMINAL_FREQUENCY
