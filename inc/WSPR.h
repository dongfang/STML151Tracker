...
#define WSPR_LOWALT_SCHEDULE_DEF {TYPE1, ALTITUDE, ALTITUDE, ALTITUDE}
#define WSPR_DEFAULT_SCHEDULE {TYPE1, ALTITUDE, REAL_EXTENDED_LOCATION, ALTITUDE, REAL_EXTENDED_LOCATION,ALTITUDE,REAL_EXTENDED_LOCATION}
